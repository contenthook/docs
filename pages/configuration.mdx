...
- `? No package.json found. Do you want to create one?` - If you choose `Yes`, the package.json will be created. Only asked if there is no package.json in the project root.
